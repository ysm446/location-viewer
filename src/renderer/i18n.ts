...
const ja: Dict = {
  ...
  'btn.generate': '新規ワークスペース作成',
  'terrain.update': '選択中の地形を更新',
  'terrain.updateConfirm':
    '選択中ワークスペースの地形を、現在の範囲・ズーム・ソースで再生成します。よろしいですか？（地点は保持されます）',
  'side.library': 'ワークスペース',
  'rtab.library': 'ワークスペース',
  'rtab.settings': '環境設定',
  'selected.none': '選択なし',
...
const en: Dict = {
  ...
  'btn.generate': 'New workspace',
  'terrain.update': 'Update terrain of selection',
  'terrain.updateConfirm':
    "Regenerate the selected workspace's terrain with the current range/zoom/source? (Landmarks are kept.)",
  'side.library': 'Workspaces',
  'rtab.library': 'Workspaces',
